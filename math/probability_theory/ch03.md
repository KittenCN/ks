...
![](../../ap/calculus/imgs/TU_probability_pdf.png)
...
![](../../ap/calculus/imgs/TU_probability_pdf_cdf_relation.png)
 
- PDF 是 CDF 的微分, CDF 是 PDF 的积分
- fₓ(x) = lim<sub>Δx→0</sub> P(x≤ X ≤x+Δx)/Δx 
- 当 Δx 很小时：P(x≤ X ≤x+Δx) = fₓ(x)·Δx
- ![](../../ap/calculus/imgs/TU_probability_pdf_calculus.png)

<h2 id="5bc2e5b291e2fbe5196f9a425ad6a0c9"></h2>

### PDF 有哪些性质呢?

![](../../ap/calculus/imgs/TU_probability_pdf_property.png)
...
![](../../ap/calculus/imgs/TU_probability2_uniform_dist.png)
...
![](../../ap/calculus/imgs/TU_probability2_exp_dist.png)
...
![](../../ap/calculus/imgs/TU_probability2_exp_dist2.png)
...
![](../../ap/calculus/imgs/TU_probability2_Erlang_dist.png)

- CDF:

![](../../ap/calculus/imgs/TU_probability2_Erlang_cdf.pn.png)
...
![](../../ap/calculus/imgs/TU_probability2_Erlang_cdf2.png)
...
- X ~ Gaussian ( μ,σ )
    - 也常有人用 X ~ N( μ,σ² ) 表示
    - ![](../../ap/calculus/imgs/TU_probability_norm_pdf.png)
    - ![](../../ap/calculus/imgs/TU_probability_norm_pdf_graph.png)
- CDF是多少?
    - 很难算，积分根本算不出来!
    - 用数值积分法去建表?
...
- Z ~ N( 0,1 )
    - ![](../../ap/calculus/imgs/TU_probability_std_norm_pdf.png)
    - ![](../../ap/calculus/imgs/TU_probability_std_norm_pdf_graph.png)
- CDF 表示为Φ(z) :
    - ![](../../ap/calculus/imgs/TU_probability_std_norm_cdf.png)
    - 积不出来，只能以数值方法近似出来后建表 给人家查
    - 网络上或是工程计算器上常能找到
- Φ(z) 的性质：
    - Φ(-z)= 1 - Φ(z) 
    - ![](../../ap/calculus/imgs/TU_probability_std_norm_property.png) 
