...
-   [堆](algorithms/chapter_heap/index.md)
    -   [堆](algorithms/chapter_heap/heap.md)
    -   [建堆操作](algorithms/chapter_heap/build_heap.md)
    -   [Top-k 问题](algorithms/chapter_heap/top_k.md)
    -   [小结](algorithms/chapter_heap/summary.md)
