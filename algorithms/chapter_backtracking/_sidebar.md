...
-   [回溯](algorithms/chapter_backtracking/index.md)
    -   [回溯算法](algorithms/chapter_backtracking/backtracking_algorithm.md)
    -   [全排列问题](algorithms/chapter_backtracking/permutations_problem.md)
    -   [子集和问题](algorithms/chapter_backtracking/subset_sum_problem.md)
    -   [N 皇后问题](algorithms/chapter_backtracking/n_queens_problem.md)
    -   [小结](algorithms/chapter_backtracking/summary.md)
