...
-   [搜索](algorithms/hello_algo/chapter_searching/index.md)
    -   [二分查找](algorithms/hello_algo/chapter_searching/binary_search.md)
    -   [二分查找插入点](algorithms/hello_algo/chapter_searching/binary_search_insertion.md)
    -   [二分查找边界](algorithms/hello_algo/chapter_searching/binary_search_edge.md)
    -   [哈希优化策略](algorithms/hello_algo/chapter_searching/replace_linear_by_hashing.md)
    -   [重识搜索算法](algorithms/hello_algo/chapter_searching/searching_algorithm_revisited.md)
    -   [小结](algorithms/hello_algo/chapter_searching/summary.md)
