...
<p>希尔排序是非稳定排序算法。时间复杂度为O(n^1.3)。</p>
<p>举个栗子：</p>
<p>49,38,65,97,76,13,27,49,55,04序列的希尔排序过程如下：</p>
<p>1. 首先选择一个间隔，通常是序列长度的一半，所以我们选择5。</p>
<p>2. 然后我们对每个子序列进行插入排序，得到的新序列为13,27,49,55,04,49,38,65,97,76。</p>
<p>3. 我们再次缩小间隔，选择间隔为2，对每个子序列进行插入排序，得到的新序列为13,27,49,38,04,49,55,65,76,97。</p>
<p>4. 最后我们选择间隔为1，进行普通的插入排序，得到的新序列为04,13,27,38,49,49,55,65,76,97。</p>
