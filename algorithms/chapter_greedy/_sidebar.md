...
-   [贪心](algorithms/chapter_greedy/index.md)
    -   [贪心算法](algorithms/chapter_greedy/greedy_algorithm.md)
    -   [分数背包问题](algorithms/chapter_greedy/fractional_knapsack_problem.md)
    -   [最大容量问题](algorithms/chapter_greedy/max_capacity_problem.md)
    -   [最大切分乘积问题](algorithms/chapter_greedy/max_product_cutting_problem.md)
    -   [小结](algorithms/chapter_greedy/summary.md)
