...
-   [树](algorithms/hello_algo/chapter_tree/index.md)
    -   [二叉树](algorithms/hello_algo/chapter_tree/binary_tree.md)
    -   [二叉树遍历](algorithms/hello_algo/chapter_tree/binary_tree_traversal.md)
    -   [二叉树数组表示](algorithms/hello_algo/chapter_tree/array_representation_of_tree.md)
    -   [二叉搜索树](algorithms/hello_algo/chapter_tree/binary_search_tree.md)
    -   [AVL 树 *](algorithms/hello_algo/chapter_tree/avl_tree.md)
    -   [小结](algorithms/hello_algo/chapter_tree/summary.md)
