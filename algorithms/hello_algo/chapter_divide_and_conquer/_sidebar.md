...
-   [分治](algorithms/hello_algo/chapter_divide_and_conquer/index.md)
    -   [分治算法](algorithms/hello_algo/chapter_divide_and_conquer/divide_and_conquer.md)
    -   [分治搜索策略](algorithms/hello_algo/chapter_divide_and_conquer/binary_search_recur.md)
    -   [构建二叉树问题](algorithms/hello_algo/chapter_divide_and_conquer/build_binary_tree_problem.md)
    -   [汉诺塔问题](algorithms/hello_algo/chapter_divide_and_conquer/hanota_problem.md)
    -   [小结](algorithms/hello_algo/chapter_divide_and_conquer/summary.md)
