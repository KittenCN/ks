...
-   [排序](algorithms/chapter_sorting/index.md)
    -   [排序算法](algorithms/chapter_sorting/sorting_algorithm.md)
    -   [选择排序](algorithms/chapter_sorting/selection_sort.md)
    -   [冒泡排序](algorithms/chapter_sorting/bubble_sort.md)
    -   [插入排序](algorithms/chapter_sorting/insertion_sort.md)
    -   [快速排序](algorithms/chapter_sorting/quick_sort.md)
    -   [归并排序](algorithms/chapter_sorting/merge_sort.md)
    -   [堆排序](algorithms/chapter_sorting/heap_sort.md)
    -   [桶排序](algorithms/chapter_sorting/bucket_sort.md)
    -   [计数排序](algorithms/chapter_sorting/counting_sort.md)
    -   [基数排序](algorithms/chapter_sorting/radix_sort.md)
    -   [小结](algorithms/chapter_sorting/summary.md)
